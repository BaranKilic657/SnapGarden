...
def extract_plant_name(answer: str) -> str:
    ...
    plant_keywords = [
        "rose", "tulip", "sunflower", "oak", "maple", "cactus", "fern",
        "aloe", "aloe vera", "basil", "mint", "succulent", "boston fern", "flamingo flower", "elephant ear", "calathea", "chili plant", "spider plant", "citrus plant",
        "Dumb Cane (Dieffenbachia)", "Dragon Tree (Dracaena)",
        "Weeping Fig (Ficus benjamina)", "Mint", "Monstera", "Orchid", "Parsley",
        "Philodendron", "Pothos", "Rosemary", "Snake Plant (Sansevieria)",
        "Peace Lily", "Succulent", "Tomato Plant", "ZZ Plant (Zamioculcas zamiifolia)"
    ]
